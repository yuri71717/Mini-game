...
<head>
    ...
    <style>
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        /* Container da imagem — cursor de mira para o jogador */
        .image-container {
            position: relative;
            max-width: 100%;
            max-height: 80vh;
            ...
            border-radius: 2px;
            overflow: hidden;
            cursor: crosshair; /* Cursor de mira em toda a área do jogo */
        }
        ...
        .game-image {
            ...
            pointer-events: none; /* Imagem não recebe clique — o container recebe */
        }

        /* ── O Ponto Alvo Escondido ── */
        .target-point {
            position: absolute;
            left: 56.4%;
            top: 51.2%;
...
<script>
    ...
    let gameOver = false; // Trava para impedir duplo submit
    ...
    targetElement.addEventListener('click', function(e) {
        ...
        // Aguarda a animação e submete
        setTimeout(() => {
            resultForm.submit();
        }, 650);
    });

    // ── Cliques incorretos no container (qualquer lugar fora do ponto) ──
    container.addEventListener('click', function(e) {
        if (gameOver) return;
        // Se o clique veio do próprio ponto, ignora
