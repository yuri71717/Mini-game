<?php 
// checa se o login ainda é válido
require_once 'session_check.php'; 

// calcula quanto tempo sobrou pra passar pro js
...
<head>
    ...
    <style>
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        /* barra do topo com nome e logout */
        .topbar {
            position: absolute;
            top: 24px;
            right: 32px;
...
<main class="main">
    ...
    <!-- topbar: nome do agente e logout -->
    <div class="topbar">
...
<script>
    ...
    // dispara a contagem a cada segundo
    const interval = setInterval(() => {
        timeRemaining--;
        if (timeRemaining <= 0) {
            clearInterval(interval);
            // tempo acabou, redireciona pro login
